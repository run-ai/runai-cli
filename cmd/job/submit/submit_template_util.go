...
func mergeTemplateToCommonSubmitArgs(submitArgs submitCommon.SubmitArgs, template *templates.SubmitTemplate, extraArgs []string) submitCommon.SubmitArgs {
...
func mergeCommandAndArgs(submitArgs *submitCommon.SubmitArgs, template *templates.SubmitTemplate, extraArgs []string) {
	submitArgs.Command = applyTemplateFieldForBool(submitArgs.Command, template.IsCommand, "command")
