...
func generateJobFiles(name, namespace string, values submitCommon.SubmittionArguments, chart, configMapUid string) (*JobFiles, error) {
...
func submitJobInternal(name, namespace string, generateSuffix bool, values submitCommon.SubmittionArguments, chart string, clientset kubernetes.Interface) (string, error) {
...
func SubmitJob(name, namespace string, generateSuffix bool, values submitCommon.SubmittionArguments, chart string, clientset kubernetes.Interface, dryRun bool) (string, error) {
	if dryRun {
